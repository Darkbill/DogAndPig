...
public class MonsterPool : MonoBehaviour
{
	...
	private void MonsterCreateEffectSet()
	{
		for (int i = 0; i < poolSiz; ++i)
		{
			GameObject eff = Instantiate(Resources.Load(
				string.Format("Effect/MonsterCreateEffect"),
	...
	{
		GameObject o = Instantiate(Resources.Load(string.Format("Monster/{0}",JsonMng.Ins.monsterDataTable[stageData.enemyIndex].monsterName))) as GameObject;
